...
export default function CreateNoteModal({ topicId, onClose, onCreate }) {
          ...
          <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto flex-1">
            ...
            <div>
              ...
              <input
                type="text"
                name="title"
                placeholder="e.g., React Hooks Pattern, API Integration Tips"
                value={form.title}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-50 text-slate-800 placeholder-slate-400 text-[14px] transition-all resize-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-50 text-slate-800 placeholder-slate-400 text-[12px] font-mono transition-all resize-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                name="tags"
                placeholder="e.g., hooks, patterns, best-practices"
                value={form.tags}
                onChange={handleChange}
                className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-50 text-slate-800 placeholder-slate-400 text-[14px] transition-all"
              />
