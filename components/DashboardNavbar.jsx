...
export default function DashboardNavbar({ onSearchOpen, onToggleSidebar, isSidebarOpen }) {
  ...
  return (
    <nav className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 sticky top-0 z-30">
      {/* Left Side - Logo and Desktop Dashboard Toggle */}
      <div className="flex items-center gap-0">
        ...
        <div className="hidden lg:block w-px h-8 bg-slate-200 mx-4" />

        {/* Desktop Dashboard Toggle - Desktop Only */}
        <div className="hidden lg:flex items-center gap-3">
          ...
          >
            {isSidebarOpen ? (
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M8 6l6 4-6 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            )}
          </button>
          ...
          {isSidebarOpen ? (
            <div className="flex items-center gap-2 px-2">
              ...
              <span className="text-[13px] font-semibold text-slate-900">Dashboard</span>
            </div>
          ) : (
            <span className="text-[13px] font-semibold text-slate-900 px-2">D</span>
          )}
        </div>
      </div>
